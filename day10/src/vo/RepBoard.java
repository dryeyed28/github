...
public class RepBoard {
	...
	public RepBoard(int board_seq, int parent_seq, String board_subject, String board_writer, String board_content,
	...
	public String toString() {
		return "RepBoard [board_seq=" + board_seq + ", parent_seq=" + parent_seq + ", board_subject=" + board_subject
				+ ", board_writer=" + board_writer + ", board_content=" + board_content + ", board_date=" + board_date
