...
<div class="board">
<div class="board_seq">
<c:set var="pagebean" value="${reqeustScope.pagebean}"/>
...
%>--%>
int i=1;
<c:forEach begin="0" end="${repboard.level}-1" var="i" step="1" vatStatus="status"/>
${▷}
${repboard.board_seq}
 </div>
 <div class="parent_seq">{repboard.parent_seq}</div> 
 <div class="parent_seq">{repboard.board_subject}</div> 
 <div class="parent_seq">{repboard.board_writer}</div> 
 <div class="parent_seq">{repboard.board_date}</div> 
 <div class="parent_seq">{repboard.board_viewcount}</div> 
 </div> 
